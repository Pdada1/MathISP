...
public class ApplyIntQuestions {
    ...
    private void generateQuestion4() {
        ...
        question = "Find the volume of the region bounded by the function y = " + displayFunction + " and the line y = " + c + " over the interval [" + x + ", " + y + "] when rotated about the x-axis."
    ...
    private void generateQuestion5() {
        ...
        question = "Find the volume of the region bounded by the function y = " + displayFunction + " and the x-axis over the interval [" + 0 + ", " + c + "] when rotated about the y-axis."
                + "\n\nPlease do not enter in terms of pi.";
    }
